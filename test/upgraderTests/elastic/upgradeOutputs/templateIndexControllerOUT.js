...
var traces = [
    ...
    },
    {
        ...
        source: {
            title: 'defaultIndex',
            timeFieldName: 'timestamp',
            fields: '[{"name":"ext.Sentado.keyword","type":"string","count":0,"scripted":false,"indexed":true,' +
            '"analyzed":false,"doc_values":true,"searchable":true,"aggregatable":true},' +
            '{"name":"ext.biases.fashion","type":"boolean","count":0,"scripted":false,"indexed":true,"analyzed":false,' +
            '"doc_values":true,"searchable":true,"aggregatable":true},' +
            '{"name":"ext.time","type":"number","count":0,"scripted":false,"indexed":true,"analyzed":false,' +
            '"doc_values":true,"searchable":true,"aggregatable":true}]'
        }
    }
];
