    ...
    config.elasticsearch.esClient.cat.indices({format: 'json'}, function(err, indices) {
        ...
        indices.forEach(function(index) {
            ...
            if (!index.index.startsWith('.')
                && !index.index.startsWith('result')
                && !index.index.startsWith('analytics')
                && !index.index.startsWith('default')
                && !index.index.startsWith('beaconing')
                && !index.index.startsWith('opaque')) {
