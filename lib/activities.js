...
module.exports = (function () {
    ...
    activities.offspring = function (activity, esClient) {
        return activities.find({rootId: activity._id.toString()}, true);
    };

    activities.children = function (activity, esClient) {
        return activities.find({parent: activity._id}, true);
    };
