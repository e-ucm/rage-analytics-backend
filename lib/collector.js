 ...
 *
 *      1 - Invoke 'start' with a valid tracking code and with authorization header <Authorization, a:>
...
module.exports = (function () {
    ...
    var getActor = function (player) {
        ...
        var actor = {
            name: player.animalName,
            account: {
                homePage: config.a2.a2HomePage,
                name: player.type === 'identified' ? player.animalName : 'Anonymous'
            }
        };
    ...
    return {
        ...
        track: function (authToken, data) {
            return authTokens.track(authToken).then(function (authToken) {
                return dataSource.add(authToken.playerId, authToken.versionId, authToken.gameplayId, authToken.session, data);
            });
        }
    };
})();