...
module.exports = (function () {
    ...
    var minTypes = {
        post: {
            '/classes/': 'teacher',
            '/activities/': 'teacher',
            '/classes/:classId/groups': 'teacher',
            '/classes/:classId/groupings': 'teacher'
        },
        get: {
            '/classes/': 'admin',
            '/classes/my': 'assistant',
            '/classes/:classId': 'student',
            '/classes/:classId/activities': 'assistant',
            '/classes/:classId/activities/my': 'student',
            '/classes/:classId/groups': 'student',
            '/classes/:classId/groupings': 'student'
        },
        put: {
    ...
    classes.isAuthorizedFor = function(classId, username, method, call) {
        ...
        return classes.findById(classId).then(function (classReq) {
            if (classReq) {
                ...
                return classes.getUserType(classReq.classId, username).then(typeComp);
            }
        });
    };
            ...
            g: function (callback) {
                ...
                return groups.getUserGroups(user)
                    .then(function (groups) {
                        r.groups = groups;
                        if (groups.length > 0) {
                            return groupings.getGroupGroupings(groups)
