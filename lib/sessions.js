...
module.exports = (function () {
    ...
    var startSessionAnalysis = function (sessionId, versionId) {
        return executeTaks(sessionId, versionId, sessions.startTasks);
    };

    var endSessionAnalysis = function (sessionId, versionId) {
        return executeTaks(sessionId, versionId, sessions.endTasks);
    };

    var executeTaks = function (sessionId, versionId, tasks) {
        var promises = [];
