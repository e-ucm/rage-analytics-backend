        ...
        if (definition) {
            ...
            if (definitionType) {
                if (endsWith(definitionType, '/')) {
                    return buildReturnError('Definition type cannot end with / for statement, ' + statement);
                }
                ...
                return buildReturnError('Definition type is missing for statement, ' + statement);
            }
        } else {
...
var toTrace = function (statement, trace) {
    ...
    if (actor) {
        ...
        if (name) {
            ...
            return buildReturnError('Actor name is missing from statement, ' + statement);
        }
    } else {
