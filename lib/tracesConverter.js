 ...
 *
 *      {
 *          event: <the verb.id, e.g. https://w3id.org/xapi/seriousgames/verbs/set --> 'set'>,
 *          target: <the object.id, e.g. https://w3id.org/xapi/seriousgames/activities/variable --> 'variable'>,
 *
 *          value: <the result.extensions.value, e.g. http://rage-eu.com/xapi/extensions/value: 1 --> '1'>,
 *                  OR
 *          progress: <the result.extensions.progress, e.g. http://rage-eu.com/xapi/extensions/progress: 0.5 --> '0.5'>,
 *                  OR
 *          response: <the result.response, e.g. result.response: 'testResponse' --> 'testResponse'>,
 *
 *          type: <the object.definition.type, e.g. object.definition.type: 'https://rage.e-ucm.es/xapi/seriousgames/activities/Cutscene' --> 'Cutscene'>,
 *
