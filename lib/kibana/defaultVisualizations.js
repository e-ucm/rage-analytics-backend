...
var defaultVisualizations = [
    {
        title: 'Total Alternatives Preferred',
    ...
    {
        title: 'Total Session Traces Count',
    ...
    {
        title: 'Different Alternatives Preferred',
    ...
    {
        title: 'Activity Count Per Player',
    ...
    {
        title: 'Alternatives Count Per Player',
    ...
    {
        title: 'Alternatives Responses Count',
    ...
    {
        title: 'Players Activity Over Time',
