...
var defaultVisualizations = [
    ...
    },
    {
        ...
        '"terms","schema":"viewBy","params":{"field":"ext.thomasKilmann.keyword","size":10,"order":"desc","orderBy":' +
        '"1","customLabel":"Thomas Kilmann"}},{"id":"3","enabled":true,"type":"date_histogram","schema":"timeSplit",' +
        '"params":{"field":"timestamp","interval":"auto","customInterval":"30m","min_doc_count":1,"extended_bounds":{},' +
    ...
    },
    {
        ...
        '{\"enabled\":true,\"id\":\"2\",\"params\":{\"field\":\"ext.thomasKilmann.keyword\",\"order\":\"desc\",' +
    ...
    },
    {
        ...
        '\"attribution\":\"Maps provided by USGS\",\"styles\":\"\"}}},\"aggs\":[{\"id\":\"1\",\"enabled\":true,' +
        '\"type\":\"count\",\"schema\":\"metric\",\"params\":{}},{\"id\":\"2\",\"enabled\":true,\"type\":\"geohash_grid\",' +
        '\"schema\":\"segment\",\"params\":{\"field\":\"ext.location\",\"autoPrecision\":true}}],\"listeners\":{}}',
    ...
    },
    {
        ...
        '"setYExtents":false,"yAxis":{}},"aggs":[{"id":"2","type":"min","schema":"metric","params":{"field":"ext.time",' +
        '"customLabel":"Min Time"}},{"id":"1","type":"avg","schema":"metric","params":{"field":"ext.time"}},{"id":"3","type":"max",' +
        '"schema":"metric","params":{"field":"ext.time","customLabel":"Max Time"}},{"id":"4","type":"terms","schema":"split",' +
