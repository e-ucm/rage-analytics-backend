...
var defaultVisualizations = [
    ...
    },
    {
        ...
        '"aggs":[{"id":"1","type":"avg","schema":"metric","params":{"field":"progress"}},{"id":"2","type":"date_histogram",' +
        '"schema":"segment","params":{"field":"stored","interval":"auto","customInterval":"2h","min_doc_count":1,"extended_bounds":{}}},' +
    ...
    },
    {
        ...
        '"type":"avg","schema":"metric","params":{"field":"progress"}},{"id":"2","type":"date_histogram","schema":"segment",' +
        '"params":{"field":"stored","interval":"auto","customInterval":"2h","min_doc_count":1,"extended_bounds":{}}},{"id":"3",' +
    ...
    },
    {
        ...
        visState: '{"aggs":[{"id":"1","params":{"field":"progress"},"schema":"metric","type":"max"},{"id":"2",' +
