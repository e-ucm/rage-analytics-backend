...
module.exports = (function () {
    ...
    kibana.createVisualizationsAndDashboard = function(config, type, object, visualizations, user, esClient, extra) {
        ...
        var Completed = function() {
            ...
            if (numPan > visualizations.length) {
                var dashboard = kibana.generateDashboard(object._id, panels, uiStates, extra);
    ...
    kibana.createVisualization = function(config, type, object, visualizationId, position, esClient) {
        ...
        switch (type){
            ...
            case 'activity': {
                cloneVisualizationPromise = kibana.cloneVisualizationForId(object.gameId, visualizationId, object._id, object.rootId, esClient);
                break;
            }
            default: {
                cloneVisualizationPromise = kibana.cloneVisualizationForId(object.gameId, visualizationId, object._id, object.rootId, esClient);
    ...
    kibana.cloneVisualizationForId = function (gameId, visualizationId, activityId, rootId, esClient) {
        var deferred = Q.defer();
